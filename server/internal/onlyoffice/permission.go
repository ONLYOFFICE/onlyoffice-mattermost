...
func (h helper) GetFilePermissionsByUserID(userID string, fileID string, post *mmModel.Post) model.Permissions {
...
func (h helper) UserHasFilePermissions(userID string, fileID string, post *mmModel.Post) bool {
	prop := post.GetProp(createPermissionsPropKeyName(userID, fileID))
	return prop != nil
}

func (h helper) SetPostFilePermissions(post *mmModel.Post, permissions []model.PostPermission) []model.PostPermission {
...
func (h helper) GetWildcardUser() string {
